...
if __name__ == "__main__":
    # 加载模型
    model = YOLO("D:/Project/YOLOnew/YOLOv8-Magic/ultralytics-8.3.12/runs/train/yolov8n_300/weights/best.pt")  # YOLOv8n模型
    model.predict(
        #source="D:/Project/data/chicken_healthy/train/images/xyxr_ship_1850.jpg",
        #source="D:\chicken data\立华\立华手机拍摄\公鸡照片\IMG_5502.JPG",
        #source="D:\chicken data\healthy\JPEGImages/xyxr_ship_866.jpg",
        #source="D:\chicken data/normal_chicken\JPEGImages/chicken_xyxr_753.jpg",
        source="D:\chicken data\网络病死鸡图\病鸡/f76bcacbf749f40b99963599f2fe4ed3.jpeg",
        save=True,  # 保存预测结果
